...
export function FAQSection() {
  const faqs = [
    ...
    {
      question: "Как происходит толкование карт?",
      answer:
        "Сервис использует классические значения всех 78 карт Таро и связывает их между собой в единое послание именно под твой вопрос — это не сухой шаблон, а живое, связное толкование.",
    },
    {
      question: "Можно ли доверять такому гаданию?",
      answer:
        "Расклад опирается на проверенные веками традиции Таро. Толкование помогает раскрыть смысл карт глубже и подробнее, но финальное решение всегда остаётся за тобой.",
    },
    {
